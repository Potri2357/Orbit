...
export const Sidebar = ({ isMobileOpen, onCloseMobile }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`glass-panel orbit-sidebar ${sidebarCollapsed ? 'sidebar-collapsed' : ''} ${isMobileOpen ? 'mobile-open' : ''}`}
        style={{
          ...
          transition: 'width 0.25s cubic-bezier(0.16, 1, 0.3, 1), min-width 0.25s cubic-bezier(0.16, 1, 0.3, 1), transform 0.25s cubic-bezier(0.16, 1, 0.3, 1)',
          zIndex: 999,
      ...
      >
        <div>
          ...
          <div style={{
            ...
            <button
              onClick={onCloseMobile}
              className="btn-ghost sidebar-mobile-close"
              style={{
                padding: '6px',
                borderRadius: 'var(--radius-sm)',
                display: 'none' // Enabled via responsive CSS on mobile
              }}
        ...
        {/* Bottom Area: User Presence & Collapse Button */}
        <div>
          <div style={{
            display: 'flex',
            alignItems: 'center',
